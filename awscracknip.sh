...
case "$1" in
  ...
  "-connect")
    ...
    ssh -i $setkey.pem ubuntu@$stringec2
    ;;
  ...
  *)
    ...
    echo "a g4dn.xlarge instance gets deployed"
    echo "Example usage:"
    echo "bash awscracknip.sh -install ssh-keyname g3.8xlarge"
    exit 1
    ;;
esac
